using Models;
using SocketServiceSample.Controls;
using SocketServiceSample.Pages;
...
namespace SocketServiceSample
{
    ...
    {
        new NavModel {Icon = Symbol.Message,PageType = typeof(MessagePage),Title = "消息"},
        new NavModel {Icon = Symbol.Setting,PageType = typeof(SettingPage),Title = "设置"}
    };
        public MainPage()
        {
